...
new Component('Chassis','Lian Li O11', 120, 'If you need storage galore, or want the extra elbow-room to enhance your rig in the future, opt for a larger case.', 'imgs/tower1.jpg');
new Component('Chassis','Rosewill D100', 100, 'If you need storage galore, or want the extra elbow-room to enhance your rig in the future, opt for a larger case.', 'imgs/tower0.jpg');
new Component('Chassis','Cooler Master MB320L', 75, 'If you need storage galore, or want the extra elbow-room to enhance your rig in the future, opt for a larger case.', 'imgs/tower0.jpg');
...
new Component('Motherboard', 'Gigabyte GA-AB350N', 125, 'Ah, the motherboard. Remember, this will determine the components you\'re able to add in the future. One of our larger motherboards will give you more flexibility to enhance your system down the road.', 'imgs/motherboard0.jpg');
new Component('Motherboard', 'MSI B250 M3', 90, 'Ah, the motherboard. Remember, this will determine the components you\'re able to add in the future. One of our larger motherboards will give you more flexibility to enhance your system down the road.', 'imgs/motherboard0.jpg');
new Component('Motherboard', 'MSI B450M', 90, 'Ah, the motherboard. Remember, this will determine the components you\'re able to add in the future. One of our larger motherboards will give you more flexibility to enhance your system down the road.', 'imgs/motherboard0.jpg');
new Component('Motherboard', 'ASRock B550', 140, 'Ah, the motherboard. Remember, this will determine the components you\'re able to add in the future. One of our larger motherboards will give you more flexibility to enhance your system down the road.', 'imgs/motherboard0.jpg');


new Component('Processor', 'Intel Core i3', 350, 'Do you edit a lot of videos? Are you a gamer looking for super smooth gameplay? Opt for a high-performance processor. It won\'t disappoint.', 'imgs/cpu3.jpg');
...
new Component('Processor', 'AMD Ryzen 5', 485, 'Do you edit a lot of videos? Are you a gamer looking for super smooth gameplay? Opt for a high-performance processor. It won\'t disappoint.', 'imgs/cpu3.jpg');
...
new Component('Processor', 'AMD Ryzen 5 2600', 120, 'Do you edit a lot of videos? Are you a gamer looking for super smooth gameplay? Opt for a high-performance processor. It won\'t disappoint.', 'imgs/cpu2.jpg');
...
new Component('Memory', 'GSkill RipJaws V', 60, 'For our gaming and productivity configurations, we went big on the RAM. But feel free to kick it up a notch if you\'re the creme-de-la-creme type. We get it.', 'imgs/ram2.jpg');
...
new Component('Memory', 'Elite+ 16GB', 60, 'For our gaming and productivity configurations, we went big on the RAM. But feel free to kick it up a notch if you\'re the creme-de-la-creme type. We get it.', 'imgs/ram2.jpg');
new Component('Memory', 'T-Force Vulcan', 65, 'For our gaming and productivity configurations, we went big on the RAM. But feel free to kick it up a notch if you\'re the creme-de-la-creme type. We get it.', 'imgs/ram3.jpg');
new Component('Memory', 'Team T-Force 16GB', 75, 'For our gaming and productivity configurations, we went big on the RAM. But feel free to kick it up a notch if you\'re the creme-de-la-creme type. We get it.', 'imgs/ram3.jpg');


new Component('Storage', 'Western Digital Blue SN550', 60, 'Both of these storage options offer monster performance. You can\'t go wrong.', 'imgs/storage2.jpg');
new Component('Storage', '1TB Solid Strong Man Hard Drive', 200, 'Both of these storage options offer monster performance. You can\'t go wrong.', 'imgs/storage3.jpg');
new Component('Storage', 'Samsung EVO 250GB', 45, 'This is the long-term, permanent data storage.', 'imgs/storage1.jpg');
new Component('Storage', 'Crucial P2 1TB', 95, 'Both of these storage options offer monster performance. You can\'t go wrong.', 'imgs/storage3.jpg');
new Component('Storage', 'SeaGate FireCoulda', 45, 'This is the long-term, permanent data storage.', 'imgs/storage1.jpg');
new Component('Storage', 'Team MP33 1TB', 80, 'Both of these storage options offer monster performance. You can\'t go wrong.', 'imgs/storage2.jpg');
...
new Component('Videocard', 'MSI GE-Force GTX 960 4GB', 160, 'Intense gamers and professional video editors, go big or go home on the video card. Ok, don\'t go home, because even our budget option will sweep you off your feet.', 'imgs/gpu1.jpg');
new Component('Videocard', 'GE-Force GTX 1660 6GB', 220, 'Intense gamers and professional video editors, go big or go home on the video card. Ok, don\'t go home, because even our budget option will sweep you off your feet.', 'imgs/gpu2.jpg');
